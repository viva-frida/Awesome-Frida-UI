...
class  EnumerateLoadedClasses  extends React.Component{
    ...
    render(){
        return(
            <div key='/enumerateLoadedClasses' style={{ border: "1px solid black", height: 450, width: 800, }} visiable={this.state.visiable}>
                            
                            <Input.Search enterButton="Submit" addonBefore="ProcessName:" value={this.state.processname} onChange={e => this.setState({
                                processname: e.target.value
                            })} style={{ width: 600 }} size={"large"} onSearch={this.onEnumerateLoadedClasses.bind(this)} />
                            <div>
